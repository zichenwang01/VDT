...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        for x, y in loader:
            ...
            # Map to normalized latent space:
            with torch.no_grad():
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", type=str, default="fluids.incompressible.Sines")
    parser.add_argument("--data-path", type=str, default="data/NS-Sines")
